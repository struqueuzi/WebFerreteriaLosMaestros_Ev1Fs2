// ========================================================
// panel-vendedor.js - GESTIÓN DE STOCK Y PEDIDOS DE CLIENTES
// ========================================================
...
if (pedidos.length === 0) {
  contenedorPedidos.innerHTML = `<tr><td colspan="7" class="text-muted text-center">No hay pedidos registrados aún.</td></tr>`;
} else {
